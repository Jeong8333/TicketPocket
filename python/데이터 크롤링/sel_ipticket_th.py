...
csv_filename = 'theater.csv'      # 크롤링 공연 정보 저장 파일명
...
url = 'https://tickets.interpark.com/contents/genre/play'    # 인터파크 티켓 - 연극 페이지 URL
# 백그라운드 실행
    ...
    while True:
        ...
        for a in a_arr:
            ...
            if performance_info not in scraped_info:
                ...
                mydb.insert(sql, ["TH00", title, poster, period_date, loc])
